...
# from pipelines.utils.conf import get_config_loader
...
stock_name_list,stock_name_list_with_ns_bo = get_tickers(file_path=r"C:\Users\abdul\ansaar-pipeline\lake_data\raw\screener_in\all_instruments.parquet")
